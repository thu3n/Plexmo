    ...
    return (
        <div className="flex min-h-dvh safe-x bg-slate-950 text-white selection:bg-amber-500/30 font-sans">
            ...
            <div className="flex-1 flex flex-col min-w-0 relative z-10">
                <SettingsHeader />
                {/* Every settings page shares the app's wide dashboard width; the
                    pages themselves lay their content out in responsive grids. */}
                <main className="flex-1 p-4 md:p-8 lg:p-12 pb-dock max-w-[1600px] mx-auto w-full">
                    {children}
                </main>
            </div>
        </div>
