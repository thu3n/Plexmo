...
export function RuleHistoryModal({ isOpen, onClose, ruleName, history }: RuleHistoryModalProps) {
    ...
    // Portaled to <body>: the settings layout's z-10 container trapped the
    // modal below the body-level global dock (z-50); z-[100] clears the dock.
    // Only rendered after a click, so document exists.
    return createPortal(
